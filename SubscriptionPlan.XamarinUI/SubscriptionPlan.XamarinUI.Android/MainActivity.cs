...
namespace SubscriptionPlan.XamarinUI.Droid
{
    [Activity(Label = "SubscriptionPlan.XamarinUI", Icon = "@mipmap/icon", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
